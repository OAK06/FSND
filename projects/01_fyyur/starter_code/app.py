...
def venues():
  ...
  #   if (venue.city+venue.state not in temp.keys()):
  #     temp[venue.city+venue.state] = {
  #       "city": venue.city,
  #       "state": venue.state,
  #       "venues": []
  #     }
  #   temp[venue.city+venue.state]['venues'].append({
  #     "id": venue.id,
  #     "name": venue.name,
...
def artists():
  ...
  data = Artist.query.options(load_only(*['id', 'name'])).order_by('id').all()
  # data=[{
  #   "id": 4,
  #   "name": "Guns N Petals",
  # }, {
